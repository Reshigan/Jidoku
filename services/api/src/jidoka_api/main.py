...
from .routers import (auth_router, decisions, documents, engagements, execution, insight, ir,
                      ledger, memory, numbering, plans, registry, schema_router, verification)
...
for r in (auth_router, engagements, ir, plans, ledger, decisions, documents, registry, schema_router,
          execution, memory, numbering, verification, insight):
